...
public final class SqlStatement extends SqlFragmentContainer implements Serializable {
     ...
     * @param isBatchUpdate true if a batch update should be performed.
     * @param getGeneratedKeys true if a generatedKeys ResultSet should be returned.
     * @param genKeyColumnNames An array of column names for generated keys.
     * @param genKeyColumnIndexes An array of column indexes for generated keys.
     * @param scrollType Type of scrolling to be supported by the generated ResultSet.
    ...
    public PreparedStatement createPreparedStatement(ControlBeanContext context, Connection connection,
                                                     ...
                                                     JdbcControl.ScrollType scrollType)
            throws SQLException {
        ...
        try {
            ...
            if (getGeneratedKeys) {
                ...
                preparedStatement = (_callableStatement)
                        ? connection.prepareCall(sql,scrollType.getType(),scrollType.getConcurrencyType())
                        : connection.prepareStatement(sql,scrollType.getType(),scrollType.getConcurrencyType());
            }
