...
// original type: ['urn:partner.soap.sforce.com']:resetPasswordResponse


public final class ResetPasswordResponseCodec 
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "urn:partner.soap.sforce.com" , "resetPasswordResponse" );

  private static final java.lang.String JAVA_TYPE = 
     "rpctypes.ResetPasswordResponse";
  ...
  //class   name = ResetPasswordResult
  //java    type = rpctypes.ResetPasswordResult
  //schema  name = ['urn:partner.soap.sforce.com']:result
  //schema  type = ['urn:partner.soap.sforce.com']:ResetPasswordResult
  ...
  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","result",null),
                                                            weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","ResetPasswordResult",null),
                                                            "result",
                                                            rpctypes.ResetPasswordResult.class,
                                                            false,
                                                            true),
  ...
  protected java.lang.Object createObject() {
    return new rpctypes.ResetPasswordResponse();
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    rpctypes.ResetPasswordResponse typed_obj = (rpctypes.ResetPasswordResponse) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(rpctypes.ResetPasswordResponse my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(rpctypes.ResetPasswordResponse my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
    ...
    case 0:
      my_obj.setResult((rpctypes.ResetPasswordResult)setter_arg);
      break;
