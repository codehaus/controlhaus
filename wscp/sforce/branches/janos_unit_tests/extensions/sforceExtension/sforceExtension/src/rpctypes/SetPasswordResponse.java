  ...
  implements java.io.Serializable
{
  ...
  public SetPasswordResponse(rpctypes.SetPasswordResult p_result) 
  {
  ...
  private rpctypes.SetPasswordResult result ;

  /**
  <br>  Derived from result.

  <br>  schema name = ['urn:partner.soap.sforce.com']:result
  <br>  schema type = ['urn:partner.soap.sforce.com']:SetPasswordResult
  <br>  schema formQualified = true
  */
  public rpctypes.SetPasswordResult getResult() {
    return result;
  }

  public void setResult(rpctypes.SetPasswordResult v) {
  ...
  public boolean equals(java.lang.Object __other__) {
    ...
    if (__other__ instanceof SetPasswordResponse) {
      
      SetPasswordResponse __obj__ =  (SetPasswordResponse) __other__;
