...
// original type: ['urn:fault.partner.soap.sforce.com']:InvalidIdFault


public final class InvalidIdFaultCodec 
  extends rpctypes.ApiFaultCodec
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "urn:fault.partner.soap.sforce.com" , "InvalidIdFault" );

  private static final java.lang.String JAVA_TYPE = 
     "rpctypes.InvalidIdFault";
  ...
  protected java.lang.Object createObject() {
    throw new java.lang.Error("not used for exception type: rpctypes.InvalidIdFault");
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    rpctypes.InvalidIdFault typed_obj = (rpctypes.InvalidIdFault) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(rpctypes.InvalidIdFault my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(rpctypes.InvalidIdFault my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    throw new java.lang.NoSuchFieldError("no properties");
