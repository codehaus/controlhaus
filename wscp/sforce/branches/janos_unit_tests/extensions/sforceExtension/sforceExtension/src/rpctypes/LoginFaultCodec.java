...
// original type: ['urn:fault.partner.soap.sforce.com']:LoginFault


public final class LoginFaultCodec 
  extends rpctypes.ApiFaultCodec
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "urn:fault.partner.soap.sforce.com" , "LoginFault" );
  ...
  protected java.lang.Object createObject() {
    throw new java.lang.Error("not used for exception type: rpctypes.LoginFault");
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    rpctypes.LoginFault typed_obj = (rpctypes.LoginFault) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(rpctypes.LoginFault my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(rpctypes.LoginFault my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    throw new java.lang.NoSuchFieldError("no properties");
