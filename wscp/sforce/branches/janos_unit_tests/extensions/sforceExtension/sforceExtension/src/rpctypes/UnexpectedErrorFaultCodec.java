...
// original type: ['urn:fault.partner.soap.sforce.com']:UnexpectedErrorFault


public final class UnexpectedErrorFaultCodec 
  extends rpctypes.ApiFaultCodec
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "urn:fault.partner.soap.sforce.com" , "UnexpectedErrorFault" );

  private static final java.lang.String JAVA_TYPE = 
     "rpctypes.UnexpectedErrorFault";
  ...
  protected java.lang.Object createObject() {
    throw new java.lang.Error("not used for exception type: rpctypes.UnexpectedErrorFault");
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    rpctypes.UnexpectedErrorFault typed_obj = (rpctypes.UnexpectedErrorFault) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(rpctypes.UnexpectedErrorFault my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(rpctypes.UnexpectedErrorFault my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    throw new java.lang.NoSuchFieldError("no properties");
