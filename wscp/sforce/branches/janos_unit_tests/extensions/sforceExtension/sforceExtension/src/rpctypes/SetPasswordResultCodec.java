...
// original type: ['urn:partner.soap.sforce.com']:SetPasswordResult


public final class SetPasswordResultCodec 
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "urn:partner.soap.sforce.com" , "SetPasswordResult" );

  private static final java.lang.String JAVA_TYPE = 
     "rpctypes.SetPasswordResult";
  ...
  protected java.lang.Object createObject() {
    return new rpctypes.SetPasswordResult();
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    rpctypes.SetPasswordResult typed_obj = (rpctypes.SetPasswordResult) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(rpctypes.SetPasswordResult my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(rpctypes.SetPasswordResult my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    throw new java.lang.NoSuchFieldError("no properties");
