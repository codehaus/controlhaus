...
public final class DeleteResultCodec 
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "urn:partner.soap.sforce.com" , "DeleteResult" );

  private static final java.lang.String JAVA_TYPE = 
     "rpctypes.DeleteResult";
  ...
  //schema  type = ['urn:partner.soap.sforce.com']:DeleteResult__errors__ArrayAnonType
  ...
  protected java.lang.Object createObject() {
    return new rpctypes.DeleteResult();
  }
  ...
  protected boolean isPropertySet(Object my_obj, int idx) {
    ...
    rpctypes.DeleteResult typed_obj = (rpctypes.DeleteResult) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(rpctypes.DeleteResult my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(rpctypes.DeleteResult my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
