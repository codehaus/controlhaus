...
public final class GetUserInfoResponseCodec 
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "urn:partner.soap.sforce.com" , "getUserInfoResponse" );

  private static final java.lang.String JAVA_TYPE = 
     "rpctypes.GetUserInfoResponse";
  ...
  //class   name = GetUserInfoResult
  //java    type = rpctypes.GetUserInfoResult
  //schema  name = ['urn:partner.soap.sforce.com']:result
  //schema  type = ['urn:partner.soap.sforce.com']:GetUserInfoResult
  ...
  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","result",null),
                                                            weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","GetUserInfoResult",null),
                                                            "result",
                                                            rpctypes.GetUserInfoResult.class,
                                                            false,
                                                            true),
  ...
  protected java.lang.Object createObject() {
    return new rpctypes.GetUserInfoResponse();
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    rpctypes.GetUserInfoResponse typed_obj = (rpctypes.GetUserInfoResponse) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(rpctypes.GetUserInfoResponse my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(rpctypes.GetUserInfoResponse my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
    ...
    case 0:
      my_obj.setResult((rpctypes.GetUserInfoResult)setter_arg);
      break;
