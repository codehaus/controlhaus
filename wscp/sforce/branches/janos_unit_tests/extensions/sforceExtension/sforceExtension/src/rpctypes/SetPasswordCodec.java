...
public final class SetPasswordCodec 
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "urn:partner.soap.sforce.com" , "setPassword" );

  private static final java.lang.String JAVA_TYPE = 
     "rpctypes.SetPassword";
  ...
  protected java.lang.Object createObject() {
    return new rpctypes.SetPassword();
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    rpctypes.SetPassword typed_obj = (rpctypes.SetPassword) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(rpctypes.SetPassword my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(rpctypes.SetPassword my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
