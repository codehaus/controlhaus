...
// original type: ['urn:partner.soap.sforce.com']:GetDeletedResult__deletedRecords__ArrayAnonType

// from array_deserialzer.j

public final class GetDeletedResultDeletedRecordsArrayAnonTypeSequenceCodec extends weblogic.xml.schema.binding.SequenceCodecBase
{
  ...
  private static final  weblogic.xml.stream.XMLName elementType =
    weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","DeletedRecord",null);

  private static final  weblogic.xml.stream.XMLName elementName = 
    weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","deletedRecords",null);
  ...
  private static final weblogic.xml.schema.binding.util.runtime.PropertyInfo _componentProp = 
    new weblogic.xml.schema.binding.util.runtime.PropertyInfo(elementType, elementName, "deletedRecords", elementClass, false, true);
