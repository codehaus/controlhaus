...
// original type: ['urn:partner.soap.sforce.com']:loginResponse


public final class LoginResponseCodec 
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "urn:partner.soap.sforce.com" , "loginResponse" );

  private static final java.lang.String JAVA_TYPE = 
     "rpctypes.LoginResponse";
  ...
  //java    type = rpctypes.LoginResult
  //schema  name = ['urn:partner.soap.sforce.com']:result
  //schema  type = ['urn:partner.soap.sforce.com']:LoginResult
  ...
  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","result",null),
                                                            weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","LoginResult",null),
                                                            "result",
                                                            rpctypes.LoginResult.class,
                                                            false,
                                                            true),
  ...
  protected java.lang.Object createObject() {
    return new rpctypes.LoginResponse();
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    rpctypes.LoginResponse typed_obj = (rpctypes.LoginResponse) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(rpctypes.LoginResponse my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(rpctypes.LoginResponse my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
    ...
    case 0:
      my_obj.setResult((rpctypes.LoginResult)setter_arg);
      break;
