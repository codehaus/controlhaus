...
// original type: ['urn:fault.partner.soap.sforce.com']:InvalidFieldFault


public final class InvalidFieldFaultCodec 
  extends rpctypes.ApiFaultCodec
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "urn:fault.partner.soap.sforce.com" , "InvalidFieldFault" );

  private static final java.lang.String JAVA_TYPE = 
     "rpctypes.InvalidFieldFault";
  ...
  protected java.lang.Object createObject() {
    throw new java.lang.Error("not used for exception type: rpctypes.InvalidFieldFault");
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    rpctypes.InvalidFieldFault typed_obj = (rpctypes.InvalidFieldFault) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(rpctypes.InvalidFieldFault my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(rpctypes.InvalidFieldFault my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    throw new java.lang.NoSuchFieldError("no properties");
