...
public final class SessionHeaderCodec 
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "urn:partner.soap.sforce.com" , "SessionHeader" );

  private static final java.lang.String JAVA_TYPE = 
     "rpctypes.SessionHeader";
  ...
  protected java.lang.Object createObject() {
    return new rpctypes.SessionHeader();
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    rpctypes.SessionHeader typed_obj = (rpctypes.SessionHeader) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(rpctypes.SessionHeader my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(rpctypes.SessionHeader my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
