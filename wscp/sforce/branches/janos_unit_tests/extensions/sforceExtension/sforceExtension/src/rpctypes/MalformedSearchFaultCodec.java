...
// original type: ['urn:fault.partner.soap.sforce.com']:MalformedSearchFault


public final class MalformedSearchFaultCodec 
  extends rpctypes.ApiFaultCodec
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "urn:fault.partner.soap.sforce.com" , "MalformedSearchFault" );

  private static final java.lang.String JAVA_TYPE = 
     "rpctypes.MalformedSearchFault";
  ...
  protected java.lang.Object createObject() {
    throw new java.lang.Error("not used for exception type: rpctypes.MalformedSearchFault");
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    rpctypes.MalformedSearchFault typed_obj = (rpctypes.MalformedSearchFault) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(rpctypes.MalformedSearchFault my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(rpctypes.MalformedSearchFault my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    throw new java.lang.NoSuchFieldError("no properties");
