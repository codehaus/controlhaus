...
/**
 * This code was automatically generated at 2:42:20 AM on May 5, 2004
...
// original type: ['urn:partner.soap.sforce.com']:getDeletedResponse


public final class GetDeletedResponseCodec 
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "urn:partner.soap.sforce.com" , "getDeletedResponse" );

  private static final java.lang.String JAVA_TYPE = 
     "rpctypes.GetDeletedResponse";
  ...
  //class   name = GetDeletedResult
  //java    type = rpctypes.GetDeletedResult
  //schema  name = ['urn:partner.soap.sforce.com']:result
  //schema  type = ['urn:partner.soap.sforce.com']:GetDeletedResult
  ...
  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","result",null),
                                                            weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","GetDeletedResult",null),
                                                            "result",
                                                            rpctypes.GetDeletedResult.class,
                                                            false,
                                                            true),
  ...
  protected java.lang.Object createObject() {
    return new rpctypes.GetDeletedResponse();
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    rpctypes.GetDeletedResponse typed_obj = (rpctypes.GetDeletedResponse) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(rpctypes.GetDeletedResponse my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(rpctypes.GetDeletedResponse my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
    ...
    case 0:
      my_obj.setResult((rpctypes.GetDeletedResult)setter_arg);
      break;
