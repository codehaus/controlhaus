  ...
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "urn:partner.soap.sforce.com" , "search" );
  ...
  //schema  name = ['urn:partner.soap.sforce.com']:searchString
  //schema  type = ['http://www.w3.org/2001/XMLSchema']:string
  //array: false primitive: false  attribute: false  formQualified: true

  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","searchString",null),
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    rpctypes.Search typed_obj = (rpctypes.Search) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(rpctypes.Search my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(rpctypes.Search my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
    ...
    case 0:
      my_obj.setSearchString((java.lang.String)setter_arg);
      break;
