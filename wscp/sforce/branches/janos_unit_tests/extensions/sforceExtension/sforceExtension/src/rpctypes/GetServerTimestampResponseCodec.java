...
// original type: ['urn:partner.soap.sforce.com']:getServerTimestampResponse


public final class GetServerTimestampResponseCodec 
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "urn:partner.soap.sforce.com" , "getServerTimestampResponse" );

  private static final java.lang.String JAVA_TYPE = 
     "rpctypes.GetServerTimestampResponse";
  ...
  //class   name = GetServerTimestampResult
  //java    type = rpctypes.GetServerTimestampResult
  //schema  name = ['urn:partner.soap.sforce.com']:result
  //schema  type = ['urn:partner.soap.sforce.com']:GetServerTimestampResult
  ...
  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","result",null),
                                                            weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","GetServerTimestampResult",null),
                                                            "result",
                                                            rpctypes.GetServerTimestampResult.class,
                                                            false,
                                                            true),
  ...
  protected java.lang.Object createObject() {
    return new rpctypes.GetServerTimestampResponse();
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    rpctypes.GetServerTimestampResponse typed_obj = (rpctypes.GetServerTimestampResponse) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(rpctypes.GetServerTimestampResponse my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(rpctypes.GetServerTimestampResponse my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
    ...
    case 0:
      my_obj.setResult((rpctypes.GetServerTimestampResult)setter_arg);
      break;
