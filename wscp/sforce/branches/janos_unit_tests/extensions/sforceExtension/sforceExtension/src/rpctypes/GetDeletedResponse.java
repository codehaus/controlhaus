  ...
  implements java.io.Serializable
{
  ...
  public GetDeletedResponse(rpctypes.GetDeletedResult p_result) 
  {
  ...
  private rpctypes.GetDeletedResult result ;

  /**
  <br>  Derived from result.

  <br>  schema name = ['urn:partner.soap.sforce.com']:result
  <br>  schema type = ['urn:partner.soap.sforce.com']:GetDeletedResult
  <br>  schema formQualified = true
  */
  public rpctypes.GetDeletedResult getResult() {
    return result;
  }

  public void setResult(rpctypes.GetDeletedResult v) {
  ...
  public boolean equals(java.lang.Object __other__) {
    ...
    if (__other__ instanceof GetDeletedResponse) {
      
      GetDeletedResponse __obj__ =  (GetDeletedResponse) __other__;
