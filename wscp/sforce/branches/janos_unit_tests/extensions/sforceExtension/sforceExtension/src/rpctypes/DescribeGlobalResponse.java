  ...
  implements java.io.Serializable
{
  ...
  public DescribeGlobalResponse(rpctypes.DescribeGlobalResult p_result) 
  {
  ...
  private rpctypes.DescribeGlobalResult result ;

  /**
  <br>  Derived from result.

  <br>  schema name = ['urn:partner.soap.sforce.com']:result
  <br>  schema type = ['urn:partner.soap.sforce.com']:DescribeGlobalResult
  <br>  schema formQualified = true
  */
  public rpctypes.DescribeGlobalResult getResult() {
    return result;
  }

  public void setResult(rpctypes.DescribeGlobalResult v) {
  ...
  public boolean equals(java.lang.Object __other__) {
    ...
    if (__other__ instanceof DescribeGlobalResponse) {
      
      DescribeGlobalResponse __obj__ =  (DescribeGlobalResponse) __other__;
