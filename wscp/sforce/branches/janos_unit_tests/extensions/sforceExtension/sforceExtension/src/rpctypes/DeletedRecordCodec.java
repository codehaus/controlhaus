...
public final class DeletedRecordCodec 
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "urn:partner.soap.sforce.com" , "DeletedRecord" );

  private static final java.lang.String JAVA_TYPE = 
     "rpctypes.DeletedRecord";
  ...
  //schema  name = ['urn:partner.soap.sforce.com']:deletedDate
  //schema  type = ['http://www.w3.org/2001/XMLSchema']:dateTime
  //array: false primitive: false  attribute: false  formQualified: true

  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","deletedDate",null),
  ...
  protected java.lang.Object createObject() {
    return new rpctypes.DeletedRecord();
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    rpctypes.DeletedRecord typed_obj = (rpctypes.DeletedRecord) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(rpctypes.DeletedRecord my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(rpctypes.DeletedRecord my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
    ...
    case 0:
      ...
      break;
    case 1:
      my_obj.setDeletedDate((java.util.Calendar)setter_arg);
      break;
