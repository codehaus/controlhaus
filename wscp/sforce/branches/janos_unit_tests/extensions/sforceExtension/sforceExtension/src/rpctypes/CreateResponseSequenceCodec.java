...
// original type: ['urn:partner.soap.sforce.com']:createResponse

// from array_deserialzer.j

public final class CreateResponseSequenceCodec extends weblogic.xml.schema.binding.SequenceCodecBase
{
  private static final  weblogic.xml.stream.XMLName XML_TYPE =
    weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","createResponse",null);
