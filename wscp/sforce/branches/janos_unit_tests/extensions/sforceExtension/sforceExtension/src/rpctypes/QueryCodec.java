  ...
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "urn:partner.soap.sforce.com" , "query" );
  ...
  //schema  name = ['urn:partner.soap.sforce.com']:queryString
  //schema  type = ['http://www.w3.org/2001/XMLSchema']:string
  //array: false primitive: false  attribute: false  formQualified: true

  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","queryString",null),
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    rpctypes.Query typed_obj = (rpctypes.Query) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(rpctypes.Query my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(rpctypes.Query my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
    ...
    case 0:
      my_obj.setQueryString((java.lang.String)setter_arg);
      break;
