...
// original type: ['urn:partner.soap.sforce.com']:retrieve__ids__ArrayAnonType

// from array_deserialzer.j

public final class RetrieveIdsArrayAnonTypeSequenceCodec extends weblogic.xml.schema.binding.SequenceCodecBase
{
  ...
  private static final  weblogic.xml.stream.XMLName elementName = 
    weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","ids",null);
  ...
  private static final weblogic.xml.schema.binding.util.runtime.PropertyInfo _componentProp = 
    new weblogic.xml.schema.binding.util.runtime.PropertyInfo(elementType, elementName, "ids", elementClass, false, true);
