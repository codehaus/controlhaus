...
public final class ResetPasswordCodec 
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "urn:partner.soap.sforce.com" , "resetPassword" );

  private static final java.lang.String JAVA_TYPE = 
     "rpctypes.ResetPassword";
  ...
  protected java.lang.Object createObject() {
    return new rpctypes.ResetPassword();
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    rpctypes.ResetPassword typed_obj = (rpctypes.ResetPassword) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(rpctypes.ResetPassword my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(rpctypes.ResetPassword my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
