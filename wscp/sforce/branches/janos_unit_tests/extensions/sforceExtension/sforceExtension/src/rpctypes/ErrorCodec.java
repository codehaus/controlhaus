  ...
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "urn:partner.soap.sforce.com" , "Error" );
  ...
  //schema  type = ['urn:partner.soap.sforce.com']:Error__fields__ArrayAnonType
  ...
  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","fields",null),
                                                            weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","Error__fields__ArrayAnonType",null),
                                                            "fields",
  ...
  //schema  name = ['urn:partner.soap.sforce.com']:message
  //schema  type = ['http://www.w3.org/2001/XMLSchema']:string
  //array: false primitive: false  attribute: false  formQualified: true

  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","message",null),
  ...
  //java    type = rpctypes.StatusCode
  //schema  name = ['urn:partner.soap.sforce.com']:statusCode
  //schema  type = ['urn:partner.soap.sforce.com']:StatusCode
  //array: false primitive: false  attribute: false  formQualified: true

  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","statusCode",null),
                                                            weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","StatusCode",null),
                                                            "statusCode",
                                                            rpctypes.StatusCode.class,
                                                            false,
                                                            true),
  ...
  protected boolean isPropertySet(Object my_obj, int idx) {
    ...
    rpctypes.Error typed_obj = (rpctypes.Error) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(rpctypes.Error my_obj, 
                                          int idx) 
  {
    ...
    case 0:
      ...
      break;
    case 1:
      obj = my_obj.getMessage();
      break;
    case 2:
      obj = my_obj.getStatusCode();
      break;
  ...
  private static void typedInvokeSetter(rpctypes.Error my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
    ...
    case 0:
      my_obj.setFields((java.lang.String[])setter_arg);
      break;
    case 1:
      my_obj.setMessage((java.lang.String)setter_arg);
      break;
    case 2:
      my_obj.setStatusCode((rpctypes.StatusCode)setter_arg);
      break;
