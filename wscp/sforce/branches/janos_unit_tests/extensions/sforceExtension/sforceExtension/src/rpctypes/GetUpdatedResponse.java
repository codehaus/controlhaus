  ...
  implements java.io.Serializable
{
  ...
  public GetUpdatedResponse(rpctypes.GetUpdatedResult p_result) 
  {
  ...
  private rpctypes.GetUpdatedResult result ;

  /**
  <br>  Derived from result.

  <br>  schema name = ['urn:partner.soap.sforce.com']:result
  <br>  schema type = ['urn:partner.soap.sforce.com']:GetUpdatedResult
  <br>  schema formQualified = true
  */
  public rpctypes.GetUpdatedResult getResult() {
    return result;
  }

  public void setResult(rpctypes.GetUpdatedResult v) {
  ...
  public boolean equals(java.lang.Object __other__) {
    ...
    if (__other__ instanceof GetUpdatedResponse) {
      
      GetUpdatedResponse __obj__ =  (GetUpdatedResponse) __other__;
