...
// original type: ['urn:partner.soap.sforce.com']:describeSObjectResponse


public final class DescribeSObjectResponseCodec 
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "urn:partner.soap.sforce.com" , "describeSObjectResponse" );

  private static final java.lang.String JAVA_TYPE = 
     "rpctypes.DescribeSObjectResponse";
  ...
  //class   name = DescribeSObjectResult
  //java    type = rpctypes.DescribeSObjectResult
  //schema  name = ['urn:partner.soap.sforce.com']:result
  //schema  type = ['urn:partner.soap.sforce.com']:DescribeSObjectResult
  ...
  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","result",null),
                                                            weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","DescribeSObjectResult",null),
                                                            "result",
                                                            rpctypes.DescribeSObjectResult.class,
                                                            false,
                                                            true),
  ...
  protected java.lang.Object createObject() {
    return new rpctypes.DescribeSObjectResponse();
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    rpctypes.DescribeSObjectResponse typed_obj = (rpctypes.DescribeSObjectResponse) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(rpctypes.DescribeSObjectResponse my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(rpctypes.DescribeSObjectResponse my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
    ...
    case 0:
      my_obj.setResult((rpctypes.DescribeSObjectResult)setter_arg);
      break;
