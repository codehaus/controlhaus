...
public final class CallOptionsCodec 
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "urn:partner.soap.sforce.com" , "CallOptions" );

  private static final java.lang.String JAVA_TYPE = 
     "rpctypes.CallOptions";
  ...
  //schema  name = ['urn:partner.soap.sforce.com']:client
  //schema  type = ['http://www.w3.org/2001/XMLSchema']:string
  //array: false primitive: false  attribute: false  formQualified: true

  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","client",null),
  ...
  protected java.lang.Object createObject() {
    return new rpctypes.CallOptions();
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    rpctypes.CallOptions typed_obj = (rpctypes.CallOptions) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(rpctypes.CallOptions my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(rpctypes.CallOptions my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
    ...
    case 0:
      my_obj.setClient((java.lang.String)setter_arg);
      break;
