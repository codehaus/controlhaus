...
/**
 * This code was automatically generated at 2:42:19 AM on May 5, 2004
...
public final class GetServerTimestampResultCodec 
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "urn:partner.soap.sforce.com" , "GetServerTimestampResult" );

  private static final java.lang.String JAVA_TYPE = 
     "rpctypes.GetServerTimestampResult";
  ...
  //schema  name = ['urn:partner.soap.sforce.com']:timestamp
  //schema  type = ['http://www.w3.org/2001/XMLSchema']:dateTime
  //array: false primitive: false  attribute: false  formQualified: true

  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","timestamp",null),
  ...
  protected java.lang.Object createObject() {
    return new rpctypes.GetServerTimestampResult();
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    rpctypes.GetServerTimestampResult typed_obj = (rpctypes.GetServerTimestampResult) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(rpctypes.GetServerTimestampResult my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(rpctypes.GetServerTimestampResult my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
    ...
    case 0:
      my_obj.setTimestamp((java.util.Calendar)setter_arg);
      break;
