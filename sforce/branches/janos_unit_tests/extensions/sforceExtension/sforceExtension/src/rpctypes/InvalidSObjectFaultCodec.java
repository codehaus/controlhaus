...
// original type: ['urn:fault.partner.soap.sforce.com']:InvalidSObjectFault


public final class InvalidSObjectFaultCodec 
  extends rpctypes.ApiFaultCodec
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "urn:fault.partner.soap.sforce.com" , "InvalidSObjectFault" );

  private static final java.lang.String JAVA_TYPE = 
     "rpctypes.InvalidSObjectFault";
  ...
  protected java.lang.Object createObject() {
    throw new java.lang.Error("not used for exception type: rpctypes.InvalidSObjectFault");
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    rpctypes.InvalidSObjectFault typed_obj = (rpctypes.InvalidSObjectFault) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(rpctypes.InvalidSObjectFault my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(rpctypes.InvalidSObjectFault my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    throw new java.lang.NoSuchFieldError("no properties");
