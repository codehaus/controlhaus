...
// original type: ['urn:fault.partner.soap.sforce.com']:MalformedQueryFault


public final class MalformedQueryFaultCodec 
  extends rpctypes.ApiFaultCodec
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "urn:fault.partner.soap.sforce.com" , "MalformedQueryFault" );

  private static final java.lang.String JAVA_TYPE = 
     "rpctypes.MalformedQueryFault";
  ...
  protected java.lang.Object createObject() {
    throw new java.lang.Error("not used for exception type: rpctypes.MalformedQueryFault");
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    rpctypes.MalformedQueryFault typed_obj = (rpctypes.MalformedQueryFault) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(rpctypes.MalformedQueryFault my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(rpctypes.MalformedQueryFault my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    throw new java.lang.NoSuchFieldError("no properties");
