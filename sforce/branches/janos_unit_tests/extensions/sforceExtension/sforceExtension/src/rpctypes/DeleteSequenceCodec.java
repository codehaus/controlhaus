...
// original type: ['urn:partner.soap.sforce.com']:delete

// from array_deserialzer.j

public final class DeleteSequenceCodec extends weblogic.xml.schema.binding.SequenceCodecBase
{
  private static final  weblogic.xml.stream.XMLName XML_TYPE =
    weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","delete",null);
