...
// original type: ['urn:partner.soap.sforce.com']:deleteResponse

// from array_deserialzer.j

public final class DeleteResponseSequenceCodec extends weblogic.xml.schema.binding.SequenceCodecBase
{
  private static final  weblogic.xml.stream.XMLName XML_TYPE =
    weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","deleteResponse",null);

  private static final  weblogic.xml.stream.XMLName elementType =
    weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","DeleteResult",null);
