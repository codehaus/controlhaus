...
/**
 * This code was automatically generated at 2:42:21 AM on May 5, 2004
...
// original type: ['urn:partner.soap.sforce.com']:queryMore


public final class QueryMoreCodec 
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "urn:partner.soap.sforce.com" , "queryMore" );
  ...
  //schema  name = ['urn:partner.soap.sforce.com']:queryLocator
  //schema  type = ['urn:partner.soap.sforce.com']:QueryLocator
  //array: false primitive: false  attribute: false  formQualified: true

  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","queryLocator",null),
                                                            weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","QueryLocator",null),
                                                            "queryLocator",
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    rpctypes.QueryMore typed_obj = (rpctypes.QueryMore) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(rpctypes.QueryMore my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(rpctypes.QueryMore my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
    ...
    case 0:
      my_obj.setQueryLocator((java.lang.String)setter_arg);
      break;
