...
/**
 * This code was automatically generated at 2:42:24 AM on May 5, 2004
...
public final class SaveOptionsCodec 
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "urn:partner.soap.sforce.com" , "SaveOptions" );

  private static final java.lang.String JAVA_TYPE = 
     "rpctypes.SaveOptions";
  ...
  //class   name = boolean
  //java    type = boolean
  //schema  name = ['urn:partner.soap.sforce.com']:autoAssign
  //schema  type = ['http://www.w3.org/2001/XMLSchema']:boolean
  //array: false primitive: true  attribute: false  formQualified: true

  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","autoAssign",null),
  ...
  //schema  name = ['urn:partner.soap.sforce.com']:assignmentRuleId
  //schema  type = ['urn:partner.soap.sforce.com']:ID
  //array: false primitive: false  attribute: false  formQualified: true

  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","assignmentRuleId",null),
  ...
  protected java.lang.Object createObject() {
    return new rpctypes.SaveOptions();
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    rpctypes.SaveOptions typed_obj = (rpctypes.SaveOptions) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(rpctypes.SaveOptions my_obj, 
                                          int idx) 
  {
    ...
    case 0:
      obj = new java.lang.Boolean(my_obj.getAutoAssign());
      break;
    case 1:
      obj = my_obj.getAssignmentRuleId();
      break;
  ...
  private static void typedInvokeSetter(rpctypes.SaveOptions my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
    ...
    case 0:
      my_obj.setAutoAssign(((java.lang.Boolean)setter_arg).booleanValue());
      break;
    case 1:
      my_obj.setAssignmentRuleId((java.lang.String)setter_arg);
      break;
