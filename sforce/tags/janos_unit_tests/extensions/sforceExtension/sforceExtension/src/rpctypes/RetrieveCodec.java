...
public final class RetrieveCodec 
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "urn:partner.soap.sforce.com" , "retrieve" );
  ...
  //schema  name = ['urn:partner.soap.sforce.com']:fieldList
  //schema  type = ['http://www.w3.org/2001/XMLSchema']:string
  //array: false primitive: false  attribute: false  formQualified: true

  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","fieldList",null),
  ...
  //schema  type = ['urn:partner.soap.sforce.com']:retrieve__ids__ArrayAnonType
  ...
  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","ids",null),
                                                            weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","retrieve__ids__ArrayAnonType",null),
                                                            "ids",
                                                            java.lang.String[].class,
                                                            false,
                                                            true),
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    rpctypes.Retrieve typed_obj = (rpctypes.Retrieve) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(rpctypes.Retrieve my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(rpctypes.Retrieve my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
    ...
    case 0:
      my_obj.setFieldList((java.lang.String)setter_arg);
      break;
    case 1:
