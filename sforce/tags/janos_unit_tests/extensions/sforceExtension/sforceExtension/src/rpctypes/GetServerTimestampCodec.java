...
// original type: ['urn:partner.soap.sforce.com']:getServerTimestamp


public final class GetServerTimestampCodec 
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "urn:partner.soap.sforce.com" , "getServerTimestamp" );

  private static final java.lang.String JAVA_TYPE = 
     "rpctypes.GetServerTimestamp";
  ...
  protected java.lang.Object createObject() {
    return new rpctypes.GetServerTimestamp();
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    rpctypes.GetServerTimestamp typed_obj = (rpctypes.GetServerTimestamp) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(rpctypes.GetServerTimestamp my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(rpctypes.GetServerTimestamp my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    throw new java.lang.NoSuchFieldError("no properties");
