...
// original type: ['urn:partner.soap.sforce.com']:DeleteResult__errors__ArrayAnonType

// from array_deserialzer.j

public final class DeleteResultErrorsArrayAnonTypeSequenceCodec extends weblogic.xml.schema.binding.SequenceCodecBase
{
  private static final  weblogic.xml.stream.XMLName XML_TYPE =
    weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","DeleteResult__errors__ArrayAnonType",null);

  private static final  weblogic.xml.stream.XMLName elementType =
    weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","Error",null);

  private static final  weblogic.xml.stream.XMLName elementName = 
    weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","errors",null);
  ...
  private static final weblogic.xml.schema.binding.util.runtime.PropertyInfo _componentProp = 
    new weblogic.xml.schema.binding.util.runtime.PropertyInfo(elementType, elementName, "errors", elementClass, false, true);
