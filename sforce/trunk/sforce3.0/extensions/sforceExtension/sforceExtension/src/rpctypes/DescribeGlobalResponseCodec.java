...
// original type: ['urn:partner.soap.sforce.com']:describeGlobalResponse


public final class DescribeGlobalResponseCodec 
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "urn:partner.soap.sforce.com" , "describeGlobalResponse" );

  private static final java.lang.String JAVA_TYPE = 
     "rpctypes.DescribeGlobalResponse";
  ...
  //class   name = DescribeGlobalResult
  //java    type = rpctypes.DescribeGlobalResult
  //schema  name = ['urn:partner.soap.sforce.com']:result
  //schema  type = ['urn:partner.soap.sforce.com']:DescribeGlobalResult
  ...
  new weblogic.xml.schema.binding.util.runtime.PropertyInfo(weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","result",null),
                                                            weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","DescribeGlobalResult",null),
                                                            "result",
                                                            rpctypes.DescribeGlobalResult.class,
                                                            false,
                                                            true),
  ...
  protected java.lang.Object createObject() {
    return new rpctypes.DescribeGlobalResponse();
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    rpctypes.DescribeGlobalResponse typed_obj = (rpctypes.DescribeGlobalResponse) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(rpctypes.DescribeGlobalResponse my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(rpctypes.DescribeGlobalResponse my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    switch(idx) {
    ...
    case 0:
      my_obj.setResult((rpctypes.DescribeGlobalResult)setter_arg);
      break;
