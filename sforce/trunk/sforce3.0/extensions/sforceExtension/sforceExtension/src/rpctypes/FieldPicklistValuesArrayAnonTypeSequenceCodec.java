...
// original type: ['urn:partner.soap.sforce.com']:Field__picklistValues__ArrayAnonType

// from array_deserialzer.j

public final class FieldPicklistValuesArrayAnonTypeSequenceCodec extends weblogic.xml.schema.binding.SequenceCodecBase
{
  ...
  private static final  weblogic.xml.stream.XMLName elementType =
    weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","PicklistEntry",null);

  private static final  weblogic.xml.stream.XMLName elementName = 
    weblogic.xml.stream.ElementFactory.createXMLName("urn:partner.soap.sforce.com","picklistValues",null);
  ...
  private static final weblogic.xml.schema.binding.util.runtime.PropertyInfo _componentProp = 
    new weblogic.xml.schema.binding.util.runtime.PropertyInfo(elementType, elementName, "picklistValues", elementClass, false, true);
