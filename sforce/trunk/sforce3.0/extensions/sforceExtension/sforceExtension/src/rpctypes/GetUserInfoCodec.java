...
// original type: ['urn:partner.soap.sforce.com']:getUserInfo


public final class GetUserInfoCodec 
  extends weblogic.xml.schema.binding.BeanCodecBase
{
  ...
  private static final weblogic.xml.stream.XMLName XML_TYPE = 
     weblogic.xml.stream.ElementFactory.createXMLName( "urn:partner.soap.sforce.com" , "getUserInfo" );

  private static final java.lang.String JAVA_TYPE = 
     "rpctypes.GetUserInfo";
  ...
  protected java.lang.Object createObject() {
    return new rpctypes.GetUserInfo();
  }
  ...
  protected java.lang.Object invokeGetter(java.lang.Object my_obj, int idx) {
    ...
    rpctypes.GetUserInfo typed_obj = (rpctypes.GetUserInfo) my_obj;
  ...
  private static java.lang.Object typedInvokeGetter(rpctypes.GetUserInfo my_obj, 
                                          int idx) 
  {
  ...
  private static void typedInvokeSetter(rpctypes.GetUserInfo my_obj, 
                                        int idx,
                                        java.lang.Object setter_arg) 
  {
    throw new java.lang.NoSuchFieldError("no properties");
