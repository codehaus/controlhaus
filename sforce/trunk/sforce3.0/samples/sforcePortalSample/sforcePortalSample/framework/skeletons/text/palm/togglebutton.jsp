...
%><render:beginRender>
 <td VALIGN=top style="background-color: #c1c1d5"> <a
    href="<render:toggleButtonUrl/>"><%= button.getAltText() %></render:beginRender>
	<render:endRender></a></td><br/></render:endRender>
