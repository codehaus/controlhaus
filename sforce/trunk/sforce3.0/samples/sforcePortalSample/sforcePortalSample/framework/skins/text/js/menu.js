...
function createSubMenu(menu, hook, contextId)
{
    ...
    for (var i = 0; i < menu.menuItems.length; i++)
    {
// @review This is an attempt to style menu items who have sub menus; if this is removed,
//         also remove the associated class from the CSS file; it messes things up big time at present.
//        if (menu.menuItems[i].menu)
//        {
//            itemClassName += "-sub";
//        }
//
